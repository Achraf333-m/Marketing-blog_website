  ...
  return (
    <>
      ...
      <main className="w-full mb-96">
        ...
        <section id="shop" className="w-full space-y-40">
          <section className="h-[80vh] w-full py-8 px-10">
            <div
              
              className="w-full h-full bg-blue-50/90 flex flex-col justify-evenly items-center shadow-2xl shadow-blue-500 rounded-lg px-10 text-black"
            >
              <Featured />
            </div>
          </section>
